...
\begin{exercise}
Show that the contraction $T:X\to X$ be a continuous function.
\end{exercise}
...
Apply the lemma for the Inverse Function Theorem, $\Phi$ is one-to-one on $B(\mathbf{0},r)$ and $B(\mathbf{0},\frac{r}{2})\subseteq\Phi(B(\mathbf{0},r))$.
